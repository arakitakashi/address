...
class PrefectureTest {
    ...
    @CsvSource(delimiter = '|', textBlock = """
        ...
        '東京都東京都東京都東京都東京都東京都東京都' | Error: Prefecture is Max 20 digits.          | 値が21文字
        ' '                                  | Error: Prefecture must not be null or blank. | 値が空文字
                                             | Error: Prefecture must not be null or blank. | 値がnull 
        """)
